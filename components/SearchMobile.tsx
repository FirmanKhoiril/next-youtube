...
const SearchMobile = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="md:hidden px-1 justify-between flex-grow flex w-full items-center z-10 absolute bg-pink-500">
      <button type="button" name="buttonBack" onClick={() => setSearchToogle((prev: boolean) => !prev)} className="p-3 rounded-full hover:bg-white/30">
      ...
      <button type="submit" name="buttonSearch" className="p-3 rounded-full hover:bg-white/30">
